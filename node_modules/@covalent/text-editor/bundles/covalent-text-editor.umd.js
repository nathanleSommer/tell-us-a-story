(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/platform-browser'), require('simplemde'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/platform-browser', 'simplemde', '@angular/common'], factory) :
	(factory((global.covalent = global.covalent || {}, global.covalent['text-editor'] = {}),global.ng.core,global.ng.forms,global.ng.platformBrowser,global.SimpleMDE,global.ng.common));
}(this, (function (exports,core,forms,platformBrowser,SimpleMDE,common) { 'use strict';
